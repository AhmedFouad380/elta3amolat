                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{url('settings/HRSetting')}}"
                                   class="text-muted">@if(Request::segment(1) == 'ar') اعدادات الهيكل الاداري @else HR
                                    Setting  @endif</a>
                            </li>
                            <li class="breadcrumb-item">
                                <a href="{{url('settings/Nationality')}}"
                                   class="text-muted">{{trans('lang.Nationality_Title')}}</a>
                            </li>
                            <li class="breadcrumb-item">
                    ...
                    <form method="post" action="{{url('Update_Nationality')}}">
                        ...
                        <div class="col-xl-12">
                            <div class="kt-section__body">
                                ...
                                <div class="form-group row">
                                    <label
                                        class="col-xl-3 col-lg-3 col-form-label">{{__('lang.Nationality_Name')}}</label>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary"
                                    data-dismiss="modal">{{__('lang.Nationality_Close')}}</button>
