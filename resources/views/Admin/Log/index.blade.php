                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <h5 class="text-dark font-weight-bold my-1 mr-5 ">{{trans('lang.logs_Title')}}</h5>
                            </li>
                        </ul>
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">{{__('lang.logs_Title')}}
                    </div>
          ...
          <span class="svg-icon svg-icon-md">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
              ...
              <!--end::Svg Icon-->
          </span> {{__('lang.logs_Create')}}</button>
                        &nbsp;&nbsp;
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable">
                        ...
                        <tr>
                            <th>#</th>
                            <th>{{__('lang.logs_Employee')}} </th>
                            <th> {{__('lang.logs_IP')}}  </th>
                            <th> {{__('lang.logs_Descriptions')}} </th>
                        </tr>
                        </thead>
                        <tbody>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        {{__('lang.logs_Create')}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    </button>
                </div>
                <div class="modal-body">
                    <form method="post" action="/Store_Log" enctype="multipart/form-data">
                        @csrf
                        <div class="col-xl-12">
                            <div class="kt-section__body">

                                <div class="form-group">
                                    <label class="col-xl-3 col-lg-3 col-form-label">{{__('lang.logs_Descriptions')}}</label>
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if(data.message == "Success")
                                {
                                    ...
                                    @endif
                                    Swal.fire("{{__('lang.btn_no')}}", "{{__('lang.Message_Delete')}}", "success");
                                    location.reload();
                                }else{
