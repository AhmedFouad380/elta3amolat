                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{url('settings/InboxGroup')}}"
                                   class="text-muted">{{trans('lang.InboxGroup_Title')}}</a>
                            </li>
                            <li class="breadcrumb-item">
                                <h5 class="text-dark font-weight-bold my-1 mr-5 ">{{trans('lang.InboxGroupMembers_Title')}}</h5>
                            </li>
                        </ul>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{url('Store_InboxGroupMembers')}}">
                        @csrf
                        <div class="col-xl-12">
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('InboxGroupMembersDatatable',$id) }}',
                    data: {
                    }
                },
                columns: [
            ...
            $.ajax({
                url: "{{ URL::to('/buttons_InboxGroupMembers')}}",
