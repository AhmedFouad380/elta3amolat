    ...
    <div class="d-flex flex-column-fluid">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{url('settings/inboxType')}}"
                                   class="text-muted">{{trans('lang.inboxType_Title')}}</a>
                            </li>
                            <li class="breadcrumb-item">
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b">
                ...
                <div class="card-body">
                    <form method="post" action="{{url('Update_inboxType')}}">
                        @csrf
                        <div class="col-xl-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        <select class="form-control" name="type">
                                                <option @if($data->type == 1) selected  @endif value="1"> {{__('lang.inboxType_tosave')}} </option>
                                                <option @if($data->type == 2) selected  @endif value="2"> {{__('lang.inboxType_export')}}  </option>
                                                <option @if($data->type == 3) selected  @endif  value="3"> {{__('lang.inboxType_Other')}}  </option>
                                        </select>
                                    </div>
                                </div>
