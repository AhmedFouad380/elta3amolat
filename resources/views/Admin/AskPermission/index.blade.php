...
@section('title')
    {{__('lang.requestslist')}}
@endsection
@section('css')
    <link href="{{asset('dashboard/assets/plugins/custom/datatables/datatables.bundle.css')}}" rel="stylesheet"
          type="text/css"/>
    <link href="{{asset('dashboard/assets/plugins/custom/jstree/jstree.bundle.css')}}" rel="stylesheet"
          type="text/css"/>
@endsection
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <h5 class="text-dark font-weight-bold my-1 mr-5 ">{{trans('lang.requestslist')}}</h5>
                            </li>
                        </ul>
                            ...
                            <table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable">
                                ...
                                @foreach($askpermissions as $askpermission)
                                    <tr>
                                        ...
                                        <td>@if($askpermission->getUser) {{$askpermission->getUser->name}} @else تم حذف الموظف @endif</td>
                                        <td>@if($askpermission->getJob) {{$askpermission->getJob->name}} @else تم حذف الوظيفة @endif</td>
                                        ...
                                        <td><a class='btn btn-raised btn-success btn-sml'
                                               href=" {{url('askpermission/'.$askpermission->id)}}">
                            ...
                            <table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable">
                                ...
                                @foreach($vacationRequests as $vacationRequest)
                                    <tr>
                                        ...
                                        <td>@if($vacationRequest->getUser) {{$vacationRequest->getUser->name}} @else تم حذف الموظف @endif</td>
                                        <td>@if($vacationRequest->getJob) {{$vacationRequest->getJob->name}} @else تم حذف الوظيفة @endif</td>
                                        <td>{{$vacationRequest->request_date}} </td>
                                        <td>{{__('lang.'.$vacationRequest->status)}} </td>
                                        <td><a class='btn btn-raised btn-success btn-sml'
                                               href=" {{url('vacationrequest/'.$vacationRequest->id)}}">
                                                <i class="fa fa-edit"></i></a>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['url' => ['requestslists'] , 'method'=>'get']) !!}
                    ...
                    <div class="form-group">
                        <strong>{{trans('lang.choosestatues')}}</strong>
                        {!! Form::select('filter_status', ['all'=>(trans('lang.all')) ,'notyet'=>trans('lang.notyet') , 'accepted'=>trans('lang.accepted') ,  'declined'=>trans('lang.declined')] , old('filter_status'), ['class'=>'form-control',null]) !!}
