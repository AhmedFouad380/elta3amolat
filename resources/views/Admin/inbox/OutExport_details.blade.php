                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <h5 class="text-dark font-weight-bold my-1 mr-5 ">{{trans('lang.Transactionsoutbound')}}</h5>
                            </li>
                        </ul>
...
{{--                                <!--end::Item-->--}}
{{--                                <div class="navi-item my-2">--}}
{{--                                    <a href="/transactions/OutExport" class="navi-link active ">--}}
{{--                  <span class="navi-icon mr-4">--}}
{{--                    <span class="svg-icon svg-icon-lg">--}}
{{--                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">--}}
{{--                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
...
{{--                </div>--}}
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-solid" type="text"  disabled name="title" required value="{{$data->title}}">
                                        </div>

                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">{{__('lang.Date_speech')}} :</label>
                                            <input class="form-control hijri-date-input" type="text"disabled value="{{$data->date}}" name="date" id="example-date-input" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class=" form-control form-control-lg "disabled  id="kt_select2_1" name="assignee_id" required>
                                                @inject('User','App\User')
                                                @foreach($User->all() as $b)
                                                    @if($data->assignee_id == $b->id)
                                                        <option selected value="{{$b->id}}"> @if(Request::segment(1) == 'ar') {{$b->name}} @else {{$b->name}} @endif </option>
                                                    @else
                                                        <option value="{{$b->id}}"> @if(Request::segment(1) == 'ar') {{$b->name}} @else {{$b->name}} @endif </option>
                                        ...
                                        <div class="form-group row">
                                            {{--                    <div class="col-lg-4">--}}
                                            {{--                      <input type="number" class="form-control form-control-lg" placeholder="213"/>--}}
                                            {{--                    </div>--}}
                                            <div class="col-lg-12">
                                                <label>{{__('lang.consignee')}} :</label>
                                                <select class="form-control  select form-control-lg" disabled id="kt_select2_1" name="third_party_id" required>
                                                    @inject('inboxThirdParty','App\inboxThirdParty')
                                                    @foreach($inboxThirdParty->all() as $b)
                                                        @if($data->third_party_id == $b->id)
                                                            <option selected value="{{$b->id}}"> @if(Request::segment(1) == 'ar') {{$b->name}} @else {{$b->en_name}} @endif </option>
                                                        @else
                                                            <option value="{{$b->id}}"> @if(Request::segment(1) == 'ar') {{$b->name}} @else {{$b->name}} @endif </option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <select class="form-control form-control-lg"  disabled id="kt_select2_1" name="attach_type_id" required>
                                                    @inject('inboxProcessType','App\inboxProcessType')
                                                    @foreach($inboxProcessType->all() as $b)
                                                        @if($data->attach_type_id == $b->id)
                                                            <option selected value="{{$b->id}}"> @if(Request::segment(1) == 'ar') {{$b->ar_name}} @else {{$b->en_name}} @endif </option>
                                                        @else
                                                            <option value="{{$b->id}}"> @if(Request::segment(1) == 'ar') {{$b->ar_name}} @else {{$b->en_name}} @endif </option>
                                        ...
                                        <div class="form-group mb-1">
                                            <label for="exampleTextarea">{{__('lang.Notes')}} :</label>
                                            <textarea class="form-control va form-control-solid" disabled name="description" id="exampleTextarea" rows="5">{{$data->description}}</textarea>
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">{{__('lang.Letter_number')}} :</label>
                                            <input class="form-control"  disabled value="{{$data->letter_num}}" type="text" name="letter_num" />
                                        </div>

                                        <div class="form-group">
                                            <label>{{__('lang.Assignment')}} :</label>

                                            <select class="form-control form-control-lg" disabled id="kt_select2_1" name="type_id" required>
                                                @inject('inboxType','App\inboxType')
                                                @foreach($inboxType->all() as $b)
                                                    @if($data->type_id == $b->id)
                                                         <option selected value="{{$b->id}}"> @if(Request::segment(1) == 'ar') {{$b->ar_name}} @else {{$b->en_name}} @endif </option>
                                                    @else
                                                        <option value="{{$b->id}}"> @if(Request::segment(1) == 'ar') {{$b->ar_name}} @else {{$b->en_name}} @endif </option>
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox-inline">
                                                <label class="checkbox">
                                                    <input type="checkbox"  disabled @if($data->is_urgent == 1) checked @endif value="1" name="is_urgent"/>
                                                    <span></span>
                                                    {{__('lang.Urgent')}}
                                                </label>
                                                <label class="checkbox">
                                                    <input type="checkbox" disabled @if($data->is_secret == 1) checked @endif  value="1" name="is_secret"/>
                                                    <span></span>
                                                    {{__('lang.secret')}}
                                                </label>
                                            </div>
    ...
    @if( session()->has("message"))
        @if( $message == "Success")
            <div class="modal fade" id="invo-add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                                ...
                                                <div class="pt-lg-0 pt-5 pb-15 text-center text-md-left">
                                                    <h3 class="font-weight-bolder text-dark font-size-h2">تذكرة المراجعة : </h3>
                                                </div>
                                                <!--end::Title-->
                                                <!--begin::Section-->
                                                @inject('User','App\User')
                                                @inject('InboxAttachment','App\InboxAttachment')
                                                <h4 class="font-weight-bolder mb-3">رقم الوارد :{{$data->id}}</h4>
                                                <div class="text-dark-50 font-weight-bold line-height-lg mb-8">
                                                    <div>تاريخ المعاملة : {{$data->created_at}}</div>
                                                    <div> منشئ المعاملة :
                                                        {{Auth::user()->name}}</div>
                                                    <div> رقم الخزينة : 5</div>
                                                </div>
                                                <!--end::Section-->
                                                <!--begin::Section-->
                                                <div class="text-dark-50 font-weight-bold line-height-lg mb-8">
                                                    <div>رقم الخطاب : {{$data->letter_num}}</div>
                                                    <div>تاريخ الخطاب : {{$data->date}}</div>
                                                </div>
                                                <!--end::Section-->
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-5">
                                            <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                                <!--begin::Title-->
                                                <!--begin::Section-->
                                                <h4 class="font-weight-bolder mb-3">الملاحظات  :{{$data->description}}</h4>
                                                <div class="text-dark-50 font-weight-bold line-height-lg mb-8">
                                                    <div>تاريخ الوارد : {{$data->created_at}}</div>
                                                    <div> عدد المرفقات   :
                                                        {{$InboxAttachment->where('inbox_id',$data->id)->count()}}</div>
                                                </div>
                                                <!--end::Section-->
                                                <!--begin::Section-->
                                                <div class="text-dark-50 font-weight-bold line-height-lg mb-8">
                                                    <div> رقم الباركود  :  0000{{$data->id}}</div>
                                                    <div> <img src="{{$data->parcode}}" style="width:80px; height: 50px;"></div>
                                                </div>
                                                <!--end::Section-->
                                            </div>
