...
{{--                      <!--begin::Item-->--}}
{{--                      <div class="navi-item my-2">--}}
{{--                          <a href="/transactions/outbox_Create" class="navi-link active">--}}
{{--                  <span class="navi-icon mr-4">--}}
{{--                    <span class="svg-icon svg-icon-lg">--}}
{{--                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">--}}
{{--                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
...
{{--      </div>--}}
      ...
      <div class="flex-row-fluid ml-lg-8 d-block" id="kt_inbox_list">
        ...
        <div class="card card-custom gutter-b">
          <div class="card-body">
            <form method="post" action="/storeOutBox" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control form-control-solid" type="text" name="title" required value="">
                  </div>
...
{{--                    <span class="form-text text-muted text-center">موظف عام</span>--}}
                ...
                <div class="col-lg-12">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="letter_num" />
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="custom-file">
                      ...
                      <label class="custom-file-label" for="customFile">{{__('lang.Choose_file')}}</label>
                    </div>
                  </div>
              ...
              <div class="card-footer">
                  <button type="submit" class="btn btn-primary mr-2">{{__('lang.Send')}}</button>
              </div>
