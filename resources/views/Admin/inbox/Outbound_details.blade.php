                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group mb-1">
                                                    <label for="exampleTextarea">{{__('lang.Date_speech')}} : {{$data->date}}</label>
                                                </div>
                                                <div class="form-group mb-1">
                                                    <label for="exampleTextarea">{{__('lang.Letter_number')}} : {{$data->letter_num}}</label>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control form-control-solid" type="text" name="it_name"  disabled value="@if($inboxThirdParty->find($data->third_party_id))  {{$inboxThirdParty->find($data->third_party_id)->name}}  @endif">
                                                </div>
                                                    ...
                                                    <table class="table table-head-bg table-borderless table-vertical-center">
                                                        ...
                                                        @foreach($explan->where('inbox_id',$data->id)->get() as $b)
                                                            <tr>
                                                                <td>1</td>
                                                                <td>
                                                                    <span class="text-dark-75"> من : @if($inboxThirdParty->find($b->third_party)) {{$inboxThirdParty->find($b->third_party)->name}} @else تم حذف الموظف  @endif
                                                                    <br>
                                                                  الموظف :   @if($User->find($b->sender_id)) {{$User->find($b->sender_id)->name}} @else تم حذف الموظف  @endif
                                                                    </span><br>
