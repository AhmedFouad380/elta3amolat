                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <h5 class="text-dark font-weight-bold my-1 mr-5 ">{{trans('lang.OutExport')}}</h5>
                            </li>
                        </ul>
...
{{--                </div>--}}
                ...
                <div class="flex-row-fluid ml-lg-8 d-block" id="kt_inbox_list">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-body">
                            <form method="get" action="/transactions/OutExportSearch">
                                <div class="row">
                                    <div class="col-lg-8">
                    ...
                    <span class="svg-icon svg-icon-warning svg-icon-3x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Communication\Mail.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                          <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                              ...
                              <path d="M5,6 L19,6 C20.1045695,6 21,6.8954305 21,8 L21,17 C21,18.1045695 20.1045695,19 19,19 L5,19 C3.8954305,19 3,18.1045695 3,17 L3,8 C3,6.8954305 3.8954305,6 5,6 Z M18.1444251,7.83964668 L12,11.1481833 L5.85557487,7.83964668 C5.4908718,7.6432681 5.03602525,7.77972206 4.83964668,8.14442513 C4.6432681,8.5091282 4.77972206,8.96397475 5.14442513,9.16035332 L11.6444251,12.6603533 C11.8664074,12.7798822 12.1335926,12.7798822 12.3555749,12.6603533 L18.8555749,9.16035332 C19.2202779,8.96397475 19.3567319,8.5091282 19.1603533,8.14442513 C18.9639747,7.77972206 18.5091282,7.6432681 18.1444251,7.83964668 Z" fill="#000000"/>
                                            ...
                                            <td> @if($inboxThirdParty->find($inbox->third_party_id)) {{$inboxThirdParty->find($inbox->third_party_id)->name}}  @else   تم حذف الجهة @endif </td>
                                            @inject('hijri_date','App\inbox')
                                            <td style="width:100px !important;">{{ Carbon\Carbon::parse($hijri_date->getHijriDate($inbox->date))->format('Y-m-d')}}</td>

                                            <td style="width:100px !important;">{{ Carbon\Carbon::parse($inbox->date)->format('Y-m-d')}}</td>
                                            ...
                                            <td nowrap="nowrap">
                                                ...
                                                @elseif($inbox->type == 4)
                                                    <a  class="btn btn-icon btn-success btn-sm btn-clean btn-icon btn-icon-md edit-Advert"  href="/transactions/OutExport_details/{{$inbox->id}}" data-original-title="Edit" title="View">
                                                        <i class="flaticon-eye icon-nm"></i>
                                                    </a>
                                                @endif
                                            </td>
