                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <h5 class="text-dark font-weight-bold my-1 mr-5 ">{{trans('lang.TransactionsSecret')}}</h5>
                            </li>
                        </ul>
...
{{--                                <!--begin::Item-->--}}
{{--                                <div class="navi-item my-2">--}}
{{--                                    <a href="/transactions/secretSearch" class="navi-link active">--}}
{{--                  <span class="navi-icon mr-4">--}}
{{--                    <span class="svg-icon svg-icon-lg">--}}
{{--                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">--}}
{{--                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
...
{{--                </div>--}}
                ...
                <div class="flex-row-fluid ml-lg-8 d-block" id="kt_inbox_list">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-body">
                            <form method="get" action="/transactions/AdvancedsecretSearch">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <label>{{__('lang.Transaction_number')}} :</label>
                                            <input class="form-control" type="number"  name="id"  id="example-date-input" />
                                        </div>
                                        <div class="form-group">
                                            <label>@if(Request::segment(1) == 'ar') من تاريخ     @else From Date  @endif :</label>
                                            <input class="form-control hijri-date-input" type="text" value="" name="from" id="example-date-input" />
                                        </div>

                                        <div class="form-group">
                                            <label>@if(Request::segment(1) == 'ar') الى  تاريخ     @else  To Date @endif :</label>
                                            <input class="form-control hijri-date-input" type="text" value="" name="to" id="example-date-input" />
                                        </div>
                                        <div class="form-group">
                                            <label>{{__('lang.Attachment_number')}} :</label>
                                            <input class="form-control" type="number"  name="attachmentCount"  id="example-date-input" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>{{__('lang.Directing_transaction')}} :</label>
                                            <select class="form-control row form-control-lg"  id="kt_select2_1" name="type_id" required>
                                                <option value="0">الكل </option>
                                        ...
                                        <div class="form-group checkbox-inline">
                                            <label  class="checkbox checkbox-outline checkbox-success">
                                                <input  type="checkbox" value="1"  name="is_archive_reciver"  id="example-date-input" />
                                                <span></span>

                                                <label>{{__('lang.saved')}} :</label>
                                            </label>
                                            <label  class="checkbox checkbox-outline checkbox-success">

                                                <input type="checkbox" value="1"  name="is_confirm"  id="example-date-input" />
                                                <span></span>
                                                <label>{{__('lang.Export_completed')}} :</label>
                                            </label>
                                        </div>
                                        <div class="form-group">
                                            <label> {{__('lang.Filter_search_results')}} :</label>
                                            <div class="radio-list">
                                                <label class="radio">
                                                    <input type="radio" name="filter" value="1"/>
                                                    <span></span>{{__('lang.All_transactions')}}</label>
                                                <label class="radio">
                                                    <input type="radio" name="filter"  value="2" />
                                                    <span></span> {{__('lang.Internal_transactions')}}</label>
                                                <label class="radio">
                                                    <input type="radio" name="filter"  value="3" />
                                                    <span></span> {{__('lang.External_transactions')}}</label>
                                            </div>
                                        </div>
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary mr-2">{{__('lang.Search')}} </button>
                                </div>
