        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">  {{__('lang.InboxGroup_Title')}}
          ...
          <span class="svg-icon svg-icon-md">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
              ...
              <!--end::Svg Icon-->
          </span> {{__('lang.InboxGroup_Create')}}</button>
                        &nbsp;&nbsp;
                ...
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  ...
                  <path d="M12.0355339,10.6213203 L14.863961,7.79289322 C15.2544853,7.40236893 15.8876503,7.40236893 16.2781746,7.79289322 C16.6686989,8.18341751 16.6686989,8.81658249 16.2781746,9.20710678 L13.4497475,12.0355339 L16.2781746,14.863961 C16.6686989,15.2544853 16.6686989,15.8876503 16.2781746,16.2781746 C15.8876503,16.6686989 15.2544853,16.6686989 14.863961,16.2781746 L12.0355339,13.4497475 L9.20710678,16.2781746 C8.81658249,16.6686989 8.18341751,16.6686989 7.79289322,16.2781746 C7.40236893,15.8876503 7.40236893,15.2544853 7.79289322,14.863961 L10.6213203,12.0355339 L7.79289322,9.20710678 C7.40236893,8.81658249 7.40236893,8.18341751 7.79289322,7.79289322 C8.18341751,7.40236893 8.81658249,7.40236893 9.20710678,7.79289322 L12.0355339,10.6213203 Z" fill="#000000"/>
                            ...
                            {{__('lang.InboxGroup_Delete')}}</button>
                        <!--end::Button-->
                    </div>
                </div>
                <div class="card-body">

                    <form method="get" action="/settings/InboxGroupSearch">
                        <div class="row">
                            <div class="col-lg-8">
                    ...
                    <table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable">
                        ...
                        <tr>
                            <th>#</th>
                            <th>{{__('lang.InboxGroup_Name')}} </th>
                            <th> {{__('lang.InboxGroup_group')}}  </th>
                            <th> {{__('lang.InboxGroup_Edit')}}  </th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach($data as $User)
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    <a  href="/settings/InboxGroupMembers/{{$User->id}}" class="btn btn-icon btn-primary btn-sm btn-clean btn-icon btn-icon-md " title="View">
                                        <i class="flaticon-users icon-nm"></i>
                                    </a>
                                </td>
                                <td nowrap="nowrap">
                                    <a  class="btn btn-icon btn-success btn-sm btn-clean btn-icon btn-icon-md edit-Advert"   data-id="{{$User->id}}" data-original-title="{{__('lang.InboxGroup_Edit')}}" title="{{__('lang.InboxGroup_Edit')}}">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        {{__('lang.InboxGroup_Create')}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    </button>
                </div>
                <div class="modal-body">
                    <form method="post" action="/Store_InboxGroup">
                        @csrf
                        <div class="col-xl-12">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content card card-outline-info">
                <div class="modal-header card-header">
                    <h3 class="modal-title" id="myLargeModalLabel">{{__('lang.InboxGroup_Edit')}}</h3>
