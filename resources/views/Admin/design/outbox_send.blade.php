            ...
            <form method="post" action="/Store_Bank">
              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    <label for="example-date-input" class="col-form-label">تاريخ الخطاب :</label>
                  ...
                  <div class="form-group">
                    <select class="form-control form-control-lg"  id="kt_select2_1" name="date_type" required>
                      <option value="">المحال اليه </option>
                      <option value="1">للاطلاع</option>
                      <option value="1">الحسابات</option>
                    </select>
                    <span class="form-text text-muted text-center">موظف محاسب</span>
                  </div>
                ...
                <div class="form-group mb-1">
                  <label for="exampleTextarea">@if(Request::segment(1) == 'ar') الملاحظات  @else  Name English @endif :</label>
                ...
                <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    <label for="example-date-input" class="col-form-label">رقم الخطاب :</label>
