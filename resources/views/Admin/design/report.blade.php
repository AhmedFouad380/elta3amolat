                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                      <label>@if(Request::segment(1) == 'ar') حدد مدة تأخير المعاملة   @else  Name English @endif :</label>
                      <input class="form-control form-control-solid" type="number" name="directorate_name" value="">
                    </div>
                    ...
                    <div class="form-group">
                      <label>@if(Request::segment(1) == 'ar') نطاق التقرير  ( radio ) @else  Name English @endif :</label>
                      <div class="radio-list">
                          <label class="radio">
                          <input type="radio" name="filter" value="اسم"/>
                          <span></span>داخل ادارة / قسم معين</label>
                          <label class="radio">
                          <input type="radio" name="filter"  value="الموضوع" />
                          <span></span> لـ موظف معين</label>
                      </div>
                    </div>

                    <div class="form-group">
                      <label>@if(Request::segment(1) == 'ar') نطاق التقرير  ( Checkbox ) @else  Name English @endif :</label>
