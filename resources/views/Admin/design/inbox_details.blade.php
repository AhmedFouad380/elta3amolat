...
@section('title')
  @if(Request::segment(1) == 'ar' ) البريد الوارد  @else Languages Settings @endif
@endsection
@section('css')
            ...
            <div class="navi navi-hover navi-active navi-link-rounded navi-bold navi-icon-center navi-light-icon">
              ...
              <div class="navi-item my-2">
                <a href="#" class="navi-link active">
                  ...
                  <span class="navi-text font-weight-bolder font-size-lg">البريد الوارد</span>
                </a>
              </div>
              <!--end::Item-->
              <!--begin::Item-->
              <div class="navi-item my-2">
                <a href="#" class="navi-link">
                  ...
                  <span class="navi-text font-weight-bolder font-size-lg">البريد الصادر</span>
                </a>
              </div>
              <!--end::Item-->
              <!--begin::Item-->
              <div class="navi-item my-2">
                <a href="#" class="navi-link">
                  ...
                  <span class="navi-text font-weight-bolder font-size-lg">انشاء بريد داخلي</span>
                </a>
              </div>
              <!--end::Item-->
              <!--begin::Item-->
              <div class="navi-item my-2">
                <a href="#" class="navi-link">
                  ...
                  <span class="navi-text font-weight-bolder font-size-lg">انشاء صادر خارجي</span>
                </a>
              </div>
              <!--end::Item-->
              <!--begin::Item-->
              <div class="navi-item my-2">
                <a href="#" class="navi-link">
                  ...
                  <span class="navi-text font-weight-bolder font-size-lg">تقارير البريد</span>
                </a>
              </div>
              <!--end::Item-->
              <!--begin::Item-->
              <div class="navi-item my-2">
                <a href="#" class="navi-link">
                  ...
                  <span class="navi-text font-weight-bolder font-size-lg">ارشيف الحفظ</span>
                </a>
              </div>
              <!--end::Item-->
              <!--begin::Item-->
              <div class="navi-item my-2">
                <a href="#" class="navi-link">
                  ...
                  <span class="navi-text font-weight-bolder font-size-lg">ارشيف الصادر</span>
                </a>
              </div>
              <!--end::Item-->
              <!--begin::Item-->
              <div class="navi-item my-2">
                <a href="#" class="navi-link">
                  ...
                  <span class="navi-text font-weight-bolder font-size-lg">البحث</span>
                </a>
              </div>
              <!--end::Item-->
              <!--begin::Item-->
              <div class="navi-item my-2">
                <a href="#" class="navi-link">
                  ...
                  <span class="navi-text font-weight-bolder font-size-lg">البحث السري</span>
                </a>
              </div>
              <!--end::Item-->
            ...
            <div class="tab-pane fade show active" id="kt_tab_pane_4_1" role="tabpanel" aria-labelledby="kt_tab_pane_4_1">
              <form method="post" action="/Store_Bank">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                      <label>@if(Request::segment(1) == 'ar') موضوع المعاملة   @else  Name Arabic @endif :</label>
                      <input class="form-control form-control-solid" type="text" name="ministry_name" value="">
                    </div>

                    <div class="form-group">
                        <label>@if(Request::segment(1) == 'ar') نوع المستند   @else  Name English @endif :</label>
                        <input class="form-control form-control-solid" type="text" name="directorate_name" value="">
                    </div>

                    <div class="form-group">
                        <label>@if(Request::segment(1) == 'ar') الاحالة   @else  Name English @endif :</label>
                        <input class="form-control form-control-solid" type="text" name="it_name" value="">
                    </div>

                    <div class="form-group">
                      <label>@if(Request::segment(1) == 'ar') اسم المرسل   @else  Name English @endif :</label>
                      <input class="form-control form-control-solid" type="text" name="it_name" value="">
                  </div>

                  <div class="form-group mb-1">
                    <label for="exampleTextarea">@if(Request::segment(1) == 'ar') الشرح  @else  Name English @endif :</label>
                    <textarea class="form-control form-control-solid" id="exampleTextarea" rows="5"></textarea>
                  </div>
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                      <select class="form-control row form-control-lg"  id="kt_select2_1" name="date_type" required>
                        <option value="">المرسل اليه </option>
                        ...
                        <tr>
                          <td>
                            <label class="checkbox checkbox-single">
                              <input type="checkbox" value="1" class="checkable" name="check_delete[]"/>
                              <span></span>
                            </label>
                          </td>
                          <td>طارق محمد عبده <br> مبرمج حاسب الي</td>
                          <td>
                            <label class="checkbox checkbox-single">
                              <input type="checkbox" value="1" class="checkable" name="check_delete[]"/>
                              <span></span>
                    ...
                    <div class="form-group">
                      <select class="form-control row form-control-lg"  id="kt_select2_1" name="date_type" required>
                        <option value="">الاحالة </option>
                        <option value="1">للاطلاع</option>
                        <option value="1">الحسابات</option>
                      </select>
                    </div>
                ...
                <div class="card-footer">
                  <button type="#" class="btn btn-primary mr-2">اعادة توجيه</button>
                  <button type="#" class="btn btn-primary mr-2">الرد على المرسل</button>
                 </div>
                      ...
                      <table class="table table-head-bg table-borderless table-vertical-center">
                        <thead>
                          <tr class="text-left text-uppercase ">
                            <th class="text-dark-75">م</th>
                            <th class="text-dark-75">الموظف</th>
                            <th class="text-dark-75">الشرح</th>
                            <th class="text-dark-75">التوجيه</th>
                            <th class="text-dark-75">التاريخ</th>
                            <th class="text-dark-75">المرفق</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td>1</td>
                            <td>
                              <span class="text-dark-75">من : طارق محمد عبده</span><br>
                              <span class="text-dark-75">الى : احمد فؤاد</span>
                            </td>
                            <td>
                              <span class="text-dark-75">الشرح الشرح الشرح الشرح الشرح</span>
                            </td>
                            <td>
                              <span class="text-dark-75">
                                <span class="label font-weight-bold label-lg label-light-primary label-inline">للاطلاع</span>
                              </span>
                            </td>
                            <td>
                              <span class="text-dark-75">25-12-2020</span>
                            </td>
                            <td class="pr-0 text-right">
                              <a href="javascript:avoid()" class="btn btn-light-success font-weight-bolder font-size-sm">32</a>
                            </td>
                          </tr>
                          <tr>
                            <td>1</td>
