          ...
          <div class="card-body">
            <form method="post" action="/Store_Bank">
              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <select class="form-control row form-control-lg"  id="kt_select2_1" name="date_type" required>
                        <option value="">برقية </option>
                        <option value="1">برقية</option>
                        <option value="1">برقية</option>
                      </select>
                    </div>
                  </div>
                ...
                <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    <label for="exampleTextarea">@if(Request::segment(1) == 'ar') المرسل اليه @else  Name English @endif :</label>
                    <select class="form-control row form-control-lg"  id="kt_select2_1" name="date_type" required>
                  ...
                  <div class="form-group">
                    ...
                    <div class="custom-file">
                      ...
                      <label class="custom-file-label" for="customFile">اختر املف</label>
                    </div>
                  </div>
              ...
              <div class="card-footer">
                <button type="#" class="btn btn-primary mr-2">ارســال</button>
              </div>
