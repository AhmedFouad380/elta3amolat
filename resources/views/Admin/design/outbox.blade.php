    ...
    <div class="d-flex flex-row">
      ...
      <div class="flex-row-fluid ml-lg-8 d-block" id="kt_inbox_list">
                  ...
                  <div class="col-lg-8">
                     ...
                     <div class="form-group row">
                      <div class="col-lg-4" style="padding-left: 0px;padding-right: 0px;">
                        <select class="form-control form-control-lg btn-success" style="border-radius: 0px;"  id="kt_select2_1" name="date_type" required>
                          <option value="0">اسم المستلم </option>
                          <option value="1">الموضوع</option>
                        </select>
                      </div>
                      <div class="col-lg-8" style="padding-left: 0px;padding-right: 0px;">
                        <input type="text" style="border-radius: 0px;" class="form-control form-control-solid form-control-lg" aria-label="Text input with dropdown button" placeholder="البحث"/>
                      </div>
                  ...
                  <div class="col-lg-7">
                    <div class="">
                      <div class="radio-inline">
                          <label class="radio">
                          <input type="radio" name="filter" value="اسم" checked="checked"/>
                          <span></span>عرض الكل</label>
                          <label class="radio">
                          <input type="radio" name="filter"  value="الموضوع" />
                          <span></span> المعاملات السرية</label>
                          <label class="radio">
                          <input type="radio" name="filter"  value="الموضوع" />
                          <span></span>المعاملات الخارجه</label>
                      </div>
                    </div>
                  </div>
        ...
        <div class="card card-custom gutter-b">
          <div class="card-body">
            <!--begin: Datatable-->
            <table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable3">
              <thead>
                <tr>
                  <th>#</th>
                  <th>خطاب</th>                 
